      ...
      <Container className="">
        <Row className="d-flex justify-content-between align-items-center">
          <Col sm="6" className="d-flex align-items-center ">
            <div className="footer-shroot ">תנאים והגבלות</div>
            <div className="footer-shroot mx-2">מדיניות פרטיות</div>
            <div className="footer-shroot mx-2">להתקשר אלינו</div>
          </Col>
          <Col
            sm="6"
          ...
          >
            <div className="d-flex pt-3 mx-2">
              ...
              <p className="footer-phone">0504248902</p>
            </div>
