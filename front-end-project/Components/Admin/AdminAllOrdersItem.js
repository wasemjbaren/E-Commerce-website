        ...
        <div className="w-100">
          <Row className="justify-content-between">
            <Col sm="12" className=" d-flex flex-row justify-content-between">
              <div className="d-inline pt-2 cat-text">הזמנה מס' 2321</div>
              <div className="d-inline pt-2 cat-text">מחיקה</div>
            </Col>
          </Row>
          ...
          <Row>
            <Col sm="12" className=" d-flex">
              <div className="mt-2  cat-text d-inline">יצרן :</div>
          ...
          <Row className="justify-content-between">
            <Col sm="12" className=" d-flex flex-row justify-content-between">
              <div className="d-inline pt-2 d-flex">
                <div className="cat-text pt-1 d-inline">כמות</div>
                <input
                  className="mx-2 mt-1"
                  type="number"
              ...
              <div className="d-inline pt-2 barnd-text">3000 שקל</div>
            </Col>
          </Row>
        </div>
      </Link>
